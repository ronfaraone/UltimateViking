...
//  PiratasViking
//
//  Created by Flavio Mitsuyoshi Tamanaha Ota on 25/03/15.
...
class PirataPerneta : CCSprite {
    ...
    override init() {
        ...
        self.physicsBody = CCPhysicsBody(rect: CGRectMake(0, 0, self.spritePirataPerneta!.contentSize.width/2, self.spritePirataPerneta!.contentSize.height), cornerRadius: 0.0)
    ...
    internal func runOver() {
        ...
        // Mata o PirataPerneta e executa o evento informado
